 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in Orchestify UI).
 */
 ...
 * to represent terminals that appear in other parts of the Orchestify UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their Orchestify OSC `SetMarker`
