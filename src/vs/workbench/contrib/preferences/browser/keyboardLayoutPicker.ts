...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in Orchestify in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open Orchestify and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
