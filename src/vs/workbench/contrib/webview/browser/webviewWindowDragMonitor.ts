...
/**
 * Allows webviews to monitor when an element in the Orchestify editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. Orchestify needs to see this
