...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit Orchestify's "shell environment" that may
	 ...
	 * a terminal used to drive some Orchestify feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to Orchestify and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** Orchestify shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
