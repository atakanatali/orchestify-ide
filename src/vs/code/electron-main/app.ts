...
/**
 * The main Orchestify application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting Orchestify');
		...
		// "com.microsoft.", which breaks native tabs for Orchestify when using this
